 <footer class="section footer-modern contextscolor footer-modern-2">
            ...
            <div class="row row-50">
              <div class="col-md-6 col-lg-4">
                ...
                <ul class="footer-modern-list d-inline-block d-sm-block wow fadeInUp">
                  ...
                  <li><a href="products.php">Alienware</a></li>
            ...
            <div class="row row-30 align-items-center">
              <div class="col-sm-6 col-md-7 col-lg-4 col-xl-4">
                <div class="row row-30 align-items-center text-lg-center">
                  <div class="col-md-7 col-xl-6"><a class="brand" href="index.php"><img src="image/icon.ico" alt="" width="198" height="66"/></a></div>
                  <div class="col-md-5 col-xl-6">
                    <div class="iso-1"><span><i class="fab fa-2x fa-affiliatetheme" alt="" width="58" height="25"></span></i><span class="iso-1-big">9.4k</span></div>
                  </div>
                </div>
              </div>
                ...
                <div class="group-xmd group-sm-justify">
                  ...
                  <div class="footer-modern-contacts wow slideInDown">
                    <div class="unit unit-spacing-sm align-items-center">
                      ...
                      <div class="unit-body"><a class="mail" href="mailto:onlinecart@gmail.com">Online cart</a></div>
                    </div>
                  </div>
        ...
        <div class="footer-modern-line-3">
          <div class="container">
            <div class="row row-10 justify-content-between">
              <div class="col-md-6"><span>L-444. Sec-12 Pratap Vihar,Ghaziabad U.P.</span></div>
              <div class="col-md-auto">
                <!-- Rights-->
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span></span><span>.&nbsp;</span><span>All Rights Reserved.</span><span> Design&nbsp;by&nbsp;<a href="index.php">Rishant Kaushik, Soumay sing rawat</a></span></p>
              </div>
            </div>
          </div>
        </div>
